...
export default function Hackathon() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("http://localhost:3000/event/hackathon", cleanedForm);
      alert("Hackathon Registered 🚀");
    } catch (err) {
      alert(err.response?.data?.message || "Error Hackathon.jsx");
    }
  };
    ...
    <div className="min-h-screen w-screen bg-[black] pt-24 pb-10 px-4 flex justify-center">
      ...
      >
        ...
        <div className="relative w-full md:w-1/2 p-6 md:p-10 overflow-y-auto max-h-[85vh]">
          ...
          <h2 className="text-3xl font-Siegra text-blue-600 mb-4">Hackathon</h2>
        ...
        <div className="hidden md:block md:w-1/2 relative">
          ...
          <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-xl p-4 rounded-xl border border-white/20">
            <p className="text-white font-Kapilar">Hackathon</p>
