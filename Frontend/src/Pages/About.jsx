      ...
      <main className="flex-grow">
        ...
        <section className=" pb-28 px-6">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
            ...
            {/* Mission Card */}
            <TiltCard>
              <div className="bg-[#111827] border border-gray-800 rounded-2xl p-10 hover:border-blue-600 transition duration-300">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={item.title}
                  className="bg-[#0d1623] border border-[#1f2a3a] rounded-2xl p-8 hover:border-blue-600 transition-all duration-300"
                >
            ...
            <TiltCard>
              <div className="rounded-xl border border-white/10 bg-gradient-to-br from-[#0f172a] to-[#0b1220] p-8 hover:border-teal-400/40 transition-all duration-300">
                ...
                <div className="flex justify-center mb-6">
                  <img
                    src={Faculty}  
                    alt="Prof Bhawesh Kumar"
                    className="w-75 h-75 md:w-75 md:h-75 rounded-xl object-cover border border-white/20"
                  />
                </div>
                ...
                <p className="text-teal-400 font-medium mb-4 text-center">
                  Assistance Professor, Department of Computer Science
                </p>

                <p className="text-gray-400 leading-relaxed text-center">
                  Prof. Bhawesh brings 10+ years of industry and academic experience, guiding the club's
